...
// file name matching
describe('0008_Int_HTML5_AutoClose_Disable-InProgress',function() {
    ...
    describe('Test for HTML5 AutoClose Disable using ADSCore',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes
                .elementByCss('iframe#iframe-content-panel').then(function(elem) {
                    ...
                    return configutils.browser.frame(elem).elementByCss('body h2').text()
...
// Countdown in string "You can close in ...----------------------------------------        
        ...
        it( 'Should Verify Header Message Text is Displayed Correctly',function(done) {
            configutils.browser
                .elementByCss('#ryInfoPanel #ryHeaderMessage').text()
                    .should .eventually .become('HTML5 Player AutoClose Disable')
                .takeScreenshot()                    
                .nodeify(done);
        });               

        it( 'Should Sleep for the close button to Enable',function(done) {
            configutils.browser           
        ...
        it( 'Should Click the Close button',function(done) {
            configutils.browser          
                .elementByCss('#ryInfoPanel #divClose')
                .click() 
                .takeScreenshot()
                .nodeify(done);                        
        });
...
// Countdown in string "You can close in ...----------------------------------------
        ...
        it( 'Should Sleep some More for the close button to Enable',function(done) {
            configutils.browser           
