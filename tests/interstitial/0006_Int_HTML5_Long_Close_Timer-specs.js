...
// file name matching
describe('0006_Int_HTML5_Long_Close_Timer-InProgress',function() {
    ...
    describe('Test for HTML5 Long Close Timer using ADSCore',function() {
        ...
        it( 'Should Verify Header Message Text is Displayed Correctly',function(done) {
            configutils.browser
                .elementByCss('#ryInfoPanel #ryHeaderMessage').text()
                    .should .eventually .become('HTML5 AutoClose Enable Skip button')
                .nodeify(done);
        });
