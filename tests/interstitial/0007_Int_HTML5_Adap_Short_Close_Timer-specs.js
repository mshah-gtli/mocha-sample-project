...
// file name matching
describe('0007_Int_HTML5_Adap_Short_Close_Timer-InProgress',function() {
    ...
    describe('Test for HTML5 Adap Short Close Timer using ADSCore',function() {
        ...
        it( 'Should Verify Header Message Text is Displayed Correctly',function(done) {
            configutils.browser
                .elementByCss('#ryInfoPanel #ryHeaderMessage').text()
                    .should .eventually .become('RockYou Test Ad')
                .nodeify(done);
        });
