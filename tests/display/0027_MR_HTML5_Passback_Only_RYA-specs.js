...
// file name matching
describe('0027_MR_HTML5_Passback_Only_RYA-InProgress',function() {
    ...
    describe('Test for MR HTML5 Passback Only using ADSCore',function() {
    ...
    // COM1:This part needs to be moved into a utility function
            ...
            .elementByCss('.ui-menu-item:nth-child(2) a[id="ui-id-2"]') // ADSCore Integrated
            .click()
