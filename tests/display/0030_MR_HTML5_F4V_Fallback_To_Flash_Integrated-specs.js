...
// file name matching
describe('0030_MR_HTML5_F4V_Fallback_To_Flash_Integrated-InProgress',function() {
    ...
    describe('Test for MR HTML5 F4V Fallback To Flash using RYA Integrated',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes            
        ...
        it( 'Should Select Ad Content Frame',function(done) {
            configutils.browser            
                .waitForElementByCss('iframe[src*="example.com/rya/service/request.php?gid=965B358796"][style*="'+height+'"]').then(function(elem){
