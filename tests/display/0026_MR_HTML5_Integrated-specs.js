...
// file name matching
describe('0026_MR_HTML5_Integrated-InProgress',function() {
    ...
    describe('Test for MR HTML5 using ADSCore Integrated',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes            
       ...
       it( 'Should Select Ad Content Frame',function(done) {
            configutils.browser
                .elementByCss('iframe[src*="example.com/rya/service/request.php?"][src*="gid='+gid+'"]').then(function(elem) {
