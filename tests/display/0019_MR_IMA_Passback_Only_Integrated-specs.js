...
// file name matching
describe('0019_MR_IMA_Passback_Only_Integrated-InProgress',function() {
    ...
    describe('Test for MR IMA Passback Only using RYA Integrated',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes            
        ...
        it( 'Should Select Ad Content Frame',function(done) {
            configutils.browser            
                .waitForElementByCss('iframe[src*="example.com/rya/service/request.php?gid=0B9C558758"][style*="'+height+'"]').then(function(elem){
