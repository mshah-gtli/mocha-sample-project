...
// file name matching
describe('0029_MR_HTML5_F4V_Fallback_To_Flash_RYA-InProgress',function() {
    ...
    describe('Test for MR HTML5 F4V Fallback To Flash using ADSCore',function() {
    ...
    // COM1:This part needs to be moved into a utility function
            ...
            .elementByCss('.ui-menu-item:nth-child(2) a[id="ui-id-2"]') // ADSCore
            .click()
