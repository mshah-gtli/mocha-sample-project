...
// file name matching
describe('0023_MR_Zynga_IMA_Mafia_Integrated-InProgress',function() {
    ...
    describe('Test for MR z IMA Ma using RYA Integrated',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes            
        ...
        it( 'Should Select Ad Content Frame',function(done) {
            configutils.browser            
                .waitForElementByCss('iframe[src*="example.com/rya/service/request.php?gid=7D41E58590"][style*="'+height+'"]').then(function(elem){
