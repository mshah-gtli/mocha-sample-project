...
// file name matching
describe('0015_DotD_IMA_AMS-InProgress',function() {
    ...
    describe('Test for DtD IMA using AMS',function() {
    ...
    // COM2:Make easy use function for selection and verification of iframes
        ...
        it( 'Should Verify Header Title Text is Displayed Correctly',function(done) {
            configutils.browser
                .sleep(5 * _periodSeconds)             
                .waitForElementByCss('#ryDotdWrapper #ryDotdHeader').text()
                    .should .eventually .become('Free Offer - IMA Player with Ad from Adap')
                .nodeify(done);
        });
